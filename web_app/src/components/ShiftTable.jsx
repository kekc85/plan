        ...
        <table className="w-full text-left border-separate border-spacing-y-1 text-xs">
          ...
          <thead className="sticky top-0 z-30 shadow-sm">
            <tr className="bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-200 border-b border-slate-300 dark:border-slate-700 select-none text-xs">
              ...
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2 px-0.5 font-extrabold tracking-wider uppercase min-w-[80px] max-w-[105px] shadow-sm">Багаж</th>
              ...
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2 px-0.5 text-center font-extrabold tracking-wider uppercase w-[108px] min-w-[105px] max-w-[112px] shadow-sm">Статус</th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2 px-0.5 font-extrabold tracking-wider uppercase min-w-[80px] max-w-[110px] shadow-sm">Примечания</th>
