        ...
        <table className="w-full text-left border-separate border-spacing-y-1 text-xs">
          ...
          <thead className="sticky top-0 z-30 shadow-sm">
            <tr className="bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-200 border-b border-slate-300 dark:border-slate-700 select-none text-xs">
              ...
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase w-14 min-w-[56px] max-w-[62px] shadow-sm">
                Номер ВС<br/>
                <span className="text-[9px] font-semibold text-slate-500 dark:text-slate-400">Тип ВС</span>
              </th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase w-11 min-w-[42px] max-w-[46px] shadow-sm">Комп.</th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase w-11 min-w-[42px] max-w-[46px] shadow-sm">PAX</th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase w-14 min-w-[56px] max-w-[62px] shadow-sm">Экипаж<br/><span className="text-[9px] font-medium text-slate-500">Л/Б/И/П</span></th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase w-[165px] min-w-[165px] max-w-[165px] text-sky-800 dark:text-sky-300 shadow-sm">Топливо и Веса<br/><span className="text-[9px] font-medium text-slate-500">Block / Trip / Taxi / DOW / DOI / Кухня</span></th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase w-12 min-w-[46px] max-w-[50px] shadow-sm">MTOW</th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase w-11 min-w-[42px] max-w-[46px] text-indigo-700 dark:text-indigo-300 shadow-sm">LIR</th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase min-w-[85px] max-w-[110px] shadow-sm">Груз</th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase min-w-[48px] max-w-[65px] shadow-sm">Почта</th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 font-extrabold tracking-wider uppercase min-w-[90px] max-w-[120px] shadow-sm">Багаж</th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase w-11 min-w-[42px] max-w-[46px] text-amber-700 dark:text-amber-300 shadow-sm">СЗВ</th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase w-11 min-w-[42px] max-w-[46px] text-emerald-700 dark:text-emerald-300 shadow-sm">LDM</th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase min-w-[68px] max-w-[75px] text-teal-700 dark:text-teal-300 shadow-sm">Астра (REN)<br/><span className="text-[9px] font-medium text-slate-500">Времена</span></th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase w-24 min-w-[92px] max-w-[98px] shadow-sm">Статус</th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 font-extrabold tracking-wider uppercase min-w-[85px] max-w-[120px] shadow-sm">Примечания</th>
              <th className="sticky top-0 bg-slate-100 dark:bg-slate-900 z-30 py-2.5 px-0.5 text-center font-extrabold tracking-wider uppercase w-16 min-w-[64px] max-w-[70px] no-print shadow-sm">Действия</th>
            </tr>
          </thead>
